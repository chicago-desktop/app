> A copy of the shell's SDK guide as of `windows/shell` 0.1.0
> ([wippy-windows/windows](https://github.com/wippy-windows/windows), `docs/sdk.md`).
...
> shell's repository, not to this application.
...
[`test/src/sdk_demo.lua`](https://github.com/wippy-windows/windows/blob/main/test/src/sdk_demo.lua). It is registered only in the
...
Before a new application, read the [skill](../.claude/skills/wippy-window-app/SKILL.md).
...
and a description of the contract to this file. The [migration audit](https://github.com/wippy-windows/windows/blob/main/docs/sdk-audit-2026-09-08.md)
