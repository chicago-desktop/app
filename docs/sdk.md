> A copy of the shell's SDK guide as of `chicago/shell` 0.2.5
...
[`test/src/sdk_demo.lua`](https://github.com/chicago-desktop/shell/blob/main/test/src/sdk_demo.lua). It is registered only in the
...
and a description of the contract to this file. The [migration audit](https://github.com/chicago-desktop/shell/blob/main/docs/sdk-audit-2026-09-08.md)
