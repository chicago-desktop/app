-- Stand format: pure, so every case runs on plain values.
...
local function define_tests()
    test.describe("Stand format: time", function()
    ...
    test.describe("Stand format: numbers", function()
    ...
    test.describe("Stand format: names", function()
    ...
    test.describe("Stand format: refusals", function()
