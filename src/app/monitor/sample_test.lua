...
local function define_tests()
    test.describe("app.monitor widgets", function()
        ...
        test.it("memory lays out in an 18×6 body without overlaps: caption, gauge, value, graph", function()
            ...
            fits(tree, 18, 6, "label,gauge,label,graph", "memory")
