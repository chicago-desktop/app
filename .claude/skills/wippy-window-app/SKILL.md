...
the shell's `docs/sdk.md` (canonical in `chicago/shell`,
[chicago-desktop/shell](https://github.com/chicago-desktop/shell); the copy
...
together in `chicago/shell`; do not copy their contracts into per-app notes.
See [the existing-window audit](https://github.com/chicago-desktop/shell/blob/main/docs/sdk-audit-2026-09-08.md)
